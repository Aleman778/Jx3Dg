...
public class Lwjgl3GL30 extends Lwjgl3GL20 implements jx3d.graphics.opengl.GL30 {
    ...
    public Buffer getBufferPointerv(int target, int pname) {
        throw new RuntimeException("getBufferPointerv is unsupported use this method from org.lwjgl.opengl.GL15 instead.");
    }
    ...
    public void texImage3D(int target, int level, int internalformat, int width, int height, int depth, int border,
        ...
        if (pixels == null)
            ...
            throw new IllegalArgumentException("Can't use " + pixels.getClass().getName()
