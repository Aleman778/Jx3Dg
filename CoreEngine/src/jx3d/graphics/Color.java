...
public class Color {
    ...
    /**
     * Constructor.
     * Creates a color based on the given components <code>(r, g, b)</code>.<br>
     * <i>Note:</i> color will be fully opaque i.e. alpha will be set to 1.0.
     *
    ...
    /**
     * Create a new color based on the given components <code>(r, g, b)</code>.<br>
     * <i>Note:</i> the color will be fully opaque i.e. alpha will be set to 1.0.
     *
     * @param red   the red component to set
     * @param green the green component to set
     * @param blue  the blue component to set
     * @return a new color represented by the given settings
     */
    ...
    /**
     * Creates a color based red, green and blue values.<br>
     * <i>Note:</i> the color will be fully opaque i.e. alpha will be set to 1.0.
     *
     * @param red   the red value to set (can be 0 through 255)
     * @param green the green value to set (can be 0 through 255)
     * @param blue  the blue value to set (can be 0 through 255)
     * @return a new color represented by the given settings
     */
    ...
    /**
     * Creates a color based red, green, blue and alpha values.
     *
     * @param red   the red value to set (can be 0 through 255)
     * @param green the green value to set (can be 0 through 255)
     * @param blue  the blue value to set (can be 0 through 255)
     ...
     *                   of gray combined with the lightness and value of 1 is a neutral value
     * @param lightness  the lightness has a value from 0 to 1 and it is used
     *                   for representing lighter or darker colors, where 0 is the color
     *                   black, 0.5 is neutral value and 1 is the color white
     * @return a new color represented by the given settings
     */
     ...
     * @return an array containing the red, green, blue values of the color
     */
    private static float[] HSLtoRGB(int hue, float saturation, float lightness) {
        float red, green, blue;

        if (saturation == 0) {
            red = green = blue = lightness; //Achromatic color
        } else {
    ...
    /**
     * Creates a new color by paring a <i>css</i> styled string.<br>
     * Supported syntax:
     * <ul>
     * <li>
     * <code>Color.web("#FF0000)"</code> or <code>Color.web("0xFF0000)"</code>
     * creates a color from the hexadecimal value <code>FF0000</code> which
     * represents the color red from the RGB color model.
     * </li>
     * <li>
     * <code>Color.web("rgb(0, 255, 0)")</code> or <code>Color.web("rgba(0, 255, 0, 100%)")</code>
     * which represents the opeque color green
     * </li>
     * </ul>
     *
     * @param color the string containing the color specification
     * @return a new color represented by the given settings
     */
    ...
    /**
     * Parses hexadecimal numbers from a string.
     *
     * @param hex the hexadecimal number
     * @return the color represented in rgba color mode
     */
    ...
    /**
     * Parse a string that specifies a color in the css rgb/ rgba syntax.
     *
     * @param rgb      the string containing the color specification
     * @param hasAlpha has the color specification an alpha component i.e. rgba
     * @return the color represented in rgba color mode
     */
    ...
    /**
     * Parse a string that specifies a color in the css hsl/ hsla syntax.
     *
     * @param hsl      the string containing the color specification
     * @param hasAlpha has the color specification an alpha component i.e. hsla
     * @return the color represented in rgba color mode
     */
    private static Color parseHSL(String hsl, boolean hasAlpha) {
        try {
            int hue;
            float saturation, lightness , alpha = 1.0f;
    ...
    /**
     * Parse a string that contains a value specified as a number, a percentage or an angle.
     *
     * @param component the value
     * @param type      the type of the value can any of the following <code>COMPONENT</code>,
     *                  <code>PERCENT</code> or <code>ANGLE</code>.
     * @return a float containing the value convertet from number, percentage or and angle
     */
    ...
    /**
     * Set the red, green, blue and alpha components in the color to the provided values.
     *
     * @param red   the value of the red component to set
     * @param green the value of the green component to set
     * @param blue  the value of the blue component to set
     * @param alpha the value of the alpha component to set
     * @return this color
     */
    ...
    public Color set(Color v) {
        return set(v.red, v.green, v.blue, v.alpha);
    }

    /**
     * Add the components of this color by the given values.
     *
     * @param red   the red component to add
     * @param green the green component to add
     * @param blue  the blue component to add
     * @param alpha the alpha component to add
    ...
    public Color add(Color v) {
        return new Color(red + v.red, green + v.green, blue + v.blue, alpha + v.alpha);
    }
     ...
     * @param alpha the alpha component to subtract
     * @return a new color holding the result
     */
    public Color sub(float red, float green, float blue, float alpha) {
        return new Color(this.red - red, this.green - green, this.blue - blue, this.alpha - alpha);
    }
    ...
    public Color mul(float s) {
        return new Color(red * s, green * s, blue * s, alpha * s);
    }

    /**
     * Multiply the components of this color by the given values.
     *
     * @param red   the red component to multiply
     * @param green the green component to multiply
     * @param blue  the blue component to multiply
     * @param alpha the alpha component to multiply
     * @return a new color holding the result
     */
    ...
    public Color inverse() {
        return new Color(1.0f - red, 1.0f - green, 1.0f - blue, 1.0f - alpha);
    }
    ...
    public Color lerp(Color v, float t, Color dest) {
        dest.red = red + (v.red - red) * t;
        dest.green = green + (v.green - green) * t;
        dest.blue = blue + (v.blue - blue) * t;
        dest.alpha = alpha + (v.alpha - alpha) * t;
        return dest;
    }
     ...
     *
     * @param red the value of the red component (valid from 0 to 1)
     */
     ...
     *
     * @return the value of the red component (integer from 0 to 255)
     */
     ...
     *
     * @param green the green value from 0 to 1
     */
    ...
    /**
     * Get the value of the green component as a float.
     *
     * @return the value of the green component (float from 0 to 1)
     */
     ...
     *
     * @return the value of the green component (integer from 0 to 255)
     */
     ...
     * Set the value of the red component.
     *
     * @param blue the blue value from 0 to 1
     */
    ...
    /**
     * Get the value of the blue component as a float.
     *
     * @return the value of the blue component (float from 0 to 1)
     */
     ...
     *
     * @return the value of the blue component (integer from 0 to 255)
     */
    ...
    /**
     * Get the value of the alpha component as a float.
     *
     * @return the value of the alpha component (float from 0 to 1)
     */
     ...
     *
     * @return the value of the alpha component (integer from 0 to 255)
     */
     ...
     * bit 25 through 32 is the alpha component.
     *
     * @return returns the color as one single integer
     */
    ...
    private static final class ColorMap {
        ...
        private static HashMap<String, Color> initColors() {
            HashMap<String, Color> colors = new HashMap<>(256);
